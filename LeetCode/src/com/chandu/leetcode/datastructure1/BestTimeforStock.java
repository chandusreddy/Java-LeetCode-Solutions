...
public class BestTimeforStock {
	...
	public static void main(String[] args) {
		...
		int prices[] = { 7, 1, 5, 9, 4 };
		BestTimeforStock profitstock = new BestTimeforStock();
		
		int maxprofit = profitstock.maxProfit(prices);
		System.out.println("The Max profit from the given stocks is: " + maxprofit);
